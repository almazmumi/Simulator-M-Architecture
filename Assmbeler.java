...
public class TesTTokenizer {
     ...
     */
        ...
        TesTTokenizer() throws FileNotFoundException{
        	initializeCommands();
        }
       ...
       public static String GetInstructionInBinary() {
    	   String Is="";
    	   if(instructionFormat.get(instArray.get(0)).equals('R') || instructionFormat.get(instArray.get(0)).equals('I')) {
    		...
    		if(!instArray.get(2).contains("R")||!instArray.get(3).contains("R")||instructionFormat.get(instArray.get(0)).equals('I')) {
    			// I type
